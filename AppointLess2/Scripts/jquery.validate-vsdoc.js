...
$.extend($.validator, {
    ...
    messages: {
        ...
        email: "Anna validi sähköpostiosoite",
        url: "Kirjoita validi URL-osoite.",
        date: "Kirjoita oikea päivämäärä.",
        dateISO: "Kirjoita validi päivämäärä (ISO).",
        number: "Anna kelvollinen numero.",
        digits: "Anna vain numerot.",
        creditcard: "Anna kelvollinen luottokortin numero.",
        equalTo: "Anna sama arvo uudelleen.",
        accept: "Anna arvo, jolla on voimassa oleva laajennus.",
        maxlength: $.validator.format("Anna enintään {0} merkkiä."),
        minlength: $.validator.format("Anna vähintään {0} merkkiä."),
        rangelength: $.validator.format("Anna arvo {0} ja {1} merkkien välillä."),
        range: $.validator.format("Anna arvo välillä {0} ja {1}."),
